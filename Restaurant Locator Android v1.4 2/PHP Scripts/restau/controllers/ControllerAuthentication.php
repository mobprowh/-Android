...
class ControllerAuthentication
{
    ...
    public function login($username, $password) 
    {
        $stmt = $this->pdo->prepare('SELECT * 
                                FROM tbl_restaurants_authentication 
    ...
    {
        $stmt = $this->pdo->prepare('INSERT INTO tbl_restaurants_authentication( username, password, name, role_id ) 
    ...
    public function updateAccessUser($itm) 
    {
        ...
        $stmt = $this->pdo->prepare('UPDATE tbl_restaurants_authentication 
                                        SET 
                                            username = :username,
                                            password = :password,
                                            name = :name
