    ...
    <div class="container">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Update Store Photo</h3>
        </div>
                ...
                <div class="col-md-6">
                  ...
                  <form action="" method="POST">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Photo URL" name="photo_url" required value="<?php echo $photo_store->photo_url;?>" >
                      </div>
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Thumbnail URL" name="thumb_url" required  value="<?php echo $photo_store->thumb_url;?>" >
                      </div>
